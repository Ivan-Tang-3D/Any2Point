...
if __name__ == "__main__":
    ...
    parser.add_argument('--coef_pro', type=float, required=True, help='th coef of attention in block')
    ...
    parser.add_argument('--adapter_dim', type=int, required=True, help='th dim of 2d adpater attn')
    ...
    cfg.model.encoder_args.adapter_args['adapter_dim'] = args.adapter_dim
    cfg.model.encoder_args.patchknn = args.patchknn
    cfg.model.encoder_args.trans = args.trans
