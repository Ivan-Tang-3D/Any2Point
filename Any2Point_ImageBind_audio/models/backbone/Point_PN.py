...
class Point_PN_scan(nn.Module):
    def __init__(self, in_channels=3, class_num=15, input_points=1024, num_stages=3, embed_dim=96, beta=100, alpha=1000, LGA_block=[2,1,1,1], dim_expansion=[2,2,2,1], type='scan', k_neighbors=64):
        super().__init__()
        # Parametric Encoder
