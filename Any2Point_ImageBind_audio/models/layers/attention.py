...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
                 drop_path=0., act_args={'act': 'gelu'}, norm_args={'norm': 'ln'}, init_values=1e-4, adapter_dim=16, drop_rate_adapter=0.1):
        super().__init__()
    ...
    def forward(self, x, center_idx=None, neighbors_idx=None, center1=None, center2=None,center3=None, args=None,attn1=None, norm3=None, idx_ptr=None, sorted_cluster_indices=None, cluster=None, grid_shape=None, mask=None,grid_shape_x=0., grid_shape_y=0., flat_grid_index=None):
