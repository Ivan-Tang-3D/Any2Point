...
class PCViews:
    ...
    def get_pos(self, points, args):
        ...
        _views = np.asarray([
            [[0 * np.pi / 2, 0, np.pi / 2], [0, 0, args.trans]],
            [[1 * np.pi / 2, 0, np.pi / 2], [0, 0, args.trans]],
            [[2 * np.pi / 2, 0, np.pi / 2], [0, 0, args.trans]],
            [[3 * np.pi / 2, 0, np.pi / 2], [0, 0, args.trans]],
            [[0, -np.pi / 2, np.pi / 2], [0, 0, args.trans]],
            [[0, np.pi / 2, np.pi / 2], [0, 0, args.trans]]])
