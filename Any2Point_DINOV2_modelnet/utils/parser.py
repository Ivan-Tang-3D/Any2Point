...
def get_args():
    ...
    # bn
    parser.add_argument('--adapter_dim', type=int, required=True, help='') 
    parser.add_argument('--trans', type=float, required=True, help='') 
    parser.add_argument('--patchknn', type=int, required=True, help='')
    parser.add_argument('--coef_3dgird', type=float, required=True, help='')
    parser.add_argument('--coef_2dgird', type=int, required=True, help='') 
    parser.add_argument('--scale_factor', type=float, required=True, help='')
