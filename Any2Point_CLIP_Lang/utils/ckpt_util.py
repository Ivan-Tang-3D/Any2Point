...
def load_checkpoint(model, pretrained_path, module=None, if_best=False, if_stat=False):
    if not os.path.exists(pretrained_path):
    ...
    ###model pos_embed_2d value replaced by ckpt's pos_embed
